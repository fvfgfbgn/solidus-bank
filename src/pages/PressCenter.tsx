              ...
              <div className="space-y-8">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Button variant="link" className="p-0">Читать полностью</Button>
                  </CardContent>
                </Card>
              ...
              <div className="space-y-8">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Button variant="link" className="p-0">Читать интервью</Button>
                  </CardContent>
                </Card>
              </div>
            </TabsContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Button variant="link" className="p-0 mt-2">Смотреть галерею</Button>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Button variant="link" className="p-0 mt-2">Смотреть запись</Button>
                  </CardContent>
                </Card>
              </div>
            </TabsContent>
